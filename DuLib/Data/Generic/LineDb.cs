...
namespace Du.Data.Generic
{
	...
	public class LineDb<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable,
		IReadOnlyCollection<KeyValuePair<TKey, TValue>>
	{
		...
		/// <param name="converter"></param>
		/// <returns></returns>
		public static LineDb<TKey, TValue> FromFile(string filename, Encoding encoding,
			IKeyValueStringConverter<TKey, TValue> converter)
		{
			var l = new LineDb<TKey, TValue>();
		...
		{
			return Db.TryGetValue(key, out var value) ? value : defvalue;
		}
